...
driver.get("https://dubai.dubizzle.com/en/property-for-rent/residential/?filters=(listed_by.value%3A%22LA%22)")
#Downloads the website using BS4
my_url = ("https://dubai.dubizzle.com/en/property-for-rent/residential/?filters=(listed_by.value%3A%22LA%22)")
# ----------------------------------------------------------------------------------------------------------------------
...
for c in containers:
    ...
    f.write(location + ';' + price + ';' + numbedrooms + ';' + phonenum + '\n')
    m = m+1
